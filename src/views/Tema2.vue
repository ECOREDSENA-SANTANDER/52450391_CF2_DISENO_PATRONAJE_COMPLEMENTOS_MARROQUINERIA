  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 2
      h1 Moldería para bolsos, billeteras y cinturones 
    ...
    .row.justify-content-end(data-aos="flip-up").fondot2.px-4
      .col-lg-12.col-12.px-lg-5.px-3.mb-lg-5
        .row.justify-content-start.mb-4(data-aos="zoom-in-left")
          .col-sm-11.col-lg-7.col-12
            .d-flex.align-items-center.mt-4
              img.w-card-icon(src="@/assets/curso/temas/Tema2/2.svg")
          ...
          .col-lg-8.col-12
            ...
            ul.lista-ul
              li.d-flex.mb-0
                ...
                p.mb-0 #[b Frente:] parte frontal, debe cortarse en la mejor sección del material.
              li.d-flex.mb-0
                i.fas.fa-check-circle
                p.mb-0 #[b Espaldar:] pieza opuesta al frente, generalmente en contacto con el cuerpo.
              li.d-flex.mb-0
                i.fas.fa-check-circle
                p.mb-0 #[b Base:] ubicada en la parte inferior, menos visible, permitiendo aprovechar zonas con imperfecciones del material.
              li.d-flex.mb-0
                i.fas.fa-check-circle
                p.mb-0 #[b Fuelle/escudo lateral:] determina el volumen del bolso; algunos diseños pueden prescindir de esta pieza.
              li.d-flex.mb-0
                i.fas.fa-check-circle
                p.mb-0 #[b Tapa:] se une al espaldar y su presencia depende del diseño.
              li.d-flex.mb-0
                i.fas.fa-check-circle
                p.mb-0 #[b Porta cierre/falso interno:] alojamiento del cierre, generalmente en la parte superior.
              li.d-flex.mb-0
                i.fas.fa-check-circle
                p.mb-0 #[b Correa/manija:] elemento de sujeción, cuya longitud y forma dependen del diseño.
              li.d-flex.mb-0
                i.fas.fa-check-circle
                p.mb-0 #[b Forro:] puede ser adherido o suelto, según el diseño.
              li.d-flex.mb-0
                i.fas.fa-check-circle
                p.mb-0 #[b Bolsillo interno:] compartimento auxiliar que mejora la organización del usuario.
    ...
    .row.justify-content-center.align-items-center.mb-5(data-aos="fade-left")
        ...
        .tarjeta.fondoslyder3.p-4
          .row.justify-content-center.align-items-center.mb-3
            .col-sm-4.col-lg-5.col-4
              img(src='@/assets/curso/temas/Tema2/1n.svg')
      ...
      .col-lg-3.col-md-6.col-12.mb-lg-0
        .tarjeta-avatar.fondoslyder3.p-4
          .row.justify-content-center.align-items-center.mb-3
            .col-sm-4.col-lg-5.col-4
              img(src='@/assets/curso/temas/Tema2/2n.svg')
          .row.justify-content-center.mb-3
            .col-lg-12.col-sm-12
      ...
      .col-lg-3.col-md-6.col-12.mb-lg-0
        .tarjeta.fondoslyder3.p-4
          .row.justify-content-center.align-items-center.mb-3
            .col-sm-4.col-lg-5.col-4
              img(src='@/assets/curso/temas/Tema2/3n.svg')
          .row.justify-content-center.mb-3
            .col-lg-12.col-sm-12
      ...
      .col-lg-3.col-md-6.col-12.mb-lg-0
        .tarjeta.fondoslyder3.p-4
          .row.justify-content-center.align-items-center.mb-3
            .col-sm-4.col-lg-5.col-4
              img(src='@/assets/curso/temas/Tema2/4n.svg')
          .row.justify-content-center.mb-3
            .col-lg-12.col-sm-12
        ...
        .row.justify-content-center.align-items-center.mb-2
          ...
          .col-lg-8
            ...
            ul.lista-ul
              li.mb-0
                i.fas.fa-check-circle
                |#[b Nombre del molde:] correspondiente a la pieza del bolso.

              li.mb-0
                i.fas.fa-check-circle
                |#[b Cantidad de piezas a cortar:] indicando la cantidad necesaria (ej. 2x1).

              li.mb-0
                i.fas.fa-check-circle
                |#[b Material:] especificación del material de corte (ej. cuero, sintético, textil).

              li.mb-0
                i.fas.fa-check-circle
                |#[b Referencia del producto:] código o nomenclatura (ej. BTP-001).
    ...
    .row.justify-content-center.align-items-center.mb-4(data-aos="flip-up")
      .col-lg-6.mb-3 
        .tarjeta.color22.px-3
          .row.align-items-center
            .col-lg-2.d-none.d-lg-block
              img(src='@/assets/curso/temas/Tema4/img002.svg', alt='')
            .col-lg-10.nota2
              br
              h5.mb-2.text-white Nota 1. 
              p.text-white Los bolsos se pueden trabajar con el forro adherido al cuerpo donde el mismo molde patrón sirve para sacar dicha pieza, o se puede sacar suelto y para ello es necesario sacar el molde del falso interno o porta cierre y por ende del forro.
    ...
    .row.justify-content-around.align-items-center
      .col-12-lg-12
        img(src="@/assets/curso/temas/Tema2/linea.svg")
