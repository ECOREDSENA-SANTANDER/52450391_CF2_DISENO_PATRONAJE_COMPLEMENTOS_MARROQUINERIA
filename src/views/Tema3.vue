  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
          ...
          .col-lg-9.col-11
            ...
            ul.lista-ul
              li.mb-0
                ...
                |#[b Manija de mano:] 30 a 35 cm.
              li.mb-0
                i.fas.fa-check-circle
                |#[b Manija mediana:] 50 a 60 cm.
              li.mb-0
                i.fas.fa-check-circle
                |#[b Manija larga:] 65 a 75 cm.
              li.mb-0
                i.fas.fa-check-circle
                |#[b Cargadera graduable:] 120 a 180 cm.
          .col-lg-3.d-none.d-lg-block
            img(src='@/assets/curso/temas/Tema3/bolso.png', alt='')
    ...
    .row.justify-content-center(data-aos="flip-up").fondot3.p-4
      .col-lg-12.col-12.px-lg-5.px-4
        ...
        .row.justify-content-center.align-items-center.mb-0
          ...
          .col-lg-4
            p #[b Manija plana:] son correas planas que pueden ser cortas, medianas o largas.

    .row.justify-content-center.align-items-center.my-2.fondomanija
      .col-lg-12
        .row.justify-content-center.align-items-center.fondocortot3.mb-4
          .col-lg-12
            .row.justify-content-center.mb-0(data-aos="zoom-in-left")
              .col-lg-8.col-11
                .row.justify-content-center.mb-0(data-aos="zoom-in-left")
                  .col-sm-12.col-lg-11.col-12.py-5
                    .d-flex.align-items-center
                      h3.bg5.py-2.w-card-text2 Molde
                ...
                .row.gris1.justify-content-center.align-items-center.p-2.mb-4
                  .col-lg-2.col-4.mb-2.col-sm-3
                    img(src='@/assets/curso/temas/Tema3/medida.svg', alt='')
                  .col-lg-4
                    p #[b Ancho:] (2.5 cm X 2) + 2 = 7 cm
                    p #[b Largo:] 110 cm
                  .col-lg-4
                    ul.lista-ul
                      li
    ...
    .row.justify-content-center.align-items-center(data-aos="zoom-in-rigth")
      .col-lg-4.mb-0.col-sm-7.col-10
        ...
        .py-2
      .col-lg-4
        p.px-2 #[b Manija con relleno:] son manijas generalmente de mano o medianas que tienen un alma que puede ser de: algodón, plástico, manguera transparente.
    
    .row.justify-content-center.align-items-center.my-3
      .col-lg-10.col-12
        .row.justify-content-center.align-items-center.fondot333.p-4.mb-0
          .col-lg-11.col-12
            .row.justify-content-center.mb-0(data-aos="zoom-in-left")
              .col-lg-11.col-11
    ...
    .row.justify-content-center.align-items-center.mb-4(data-aos="flip-up")
      ...
      .col-lg-4
        p #[b Chapetas:] pieza que permite agarrar el herraje para unirlo al bolso y posteriormente colocar la manija o cargadera.
    
    .row.justify-content-center.align-items-center.my-2.fondolargot3
      .col-lg-12
        .row.justify-content-center.mb-0(data-aos="zoom-in-left")
          .col-lg-8.col-12.col-md-12
            .row.justify-content-center.mb-0(data-aos="zoom-in-left")
              .col-sm-12.col-lg-12.col-11.py-5
                .d-flex.align-items-center
                  h3.bg5.py-2.w-card-text2 Molde
    ...
    .row.justify-content-center.mb-4(data-aos="zoom-in-left")
      .col-sm-12.col-lg-10.col-12
        .d-flex.align-items-center.mt-4
          img.w-card-icon(src="@/assets/curso/temas/Tema3/icot3.png")
          h3.bg2.py-2.w-card-text.text-white Molde de porta documentos
    
    .row.justify-content-center.mb-5.align-items-center(data-aos="flip-up")
      .col-lg-1.d-none.d-lg-block
        img(src='@/assets/curso/temas/Tema3/billetera.svg', alt='')
      .col-lg-6
        p A través del molde patrón sobre la línea trazada con los 10 cm hacia abajo se comienza a trabajar el molde de porta documentos. Sobre dicha línea se toman 8 cm hacia abajo y se traza una línea horizontal. Luego sobre la línea trazada, se agrega ventaja de costura a los dos lados (superior e inferior). 
      .col-lg-5.col-sm-10
        img(src='@/assets/curso/temas/Tema3/img05.png', alt='')
    
    .fondorecta
      .row.justify-content-center.align-items-center.fondolargot32.mb-4
        .col-lg-12.col-11
          ...
          .row.justify-content-center.mb-2(data-aos="zoom-in-left")
            .col-lg-11.col-sm-12
              ...
              .row.align-items-center.justify-content-center(data-aos="flip-up")
                .col-lg-8.col-md-12
                  p A continuación, se deben marcar puntos de referencia para realizar calados. Estos se trazarán teniendo como margen lateral derecha 8 mm y una margen inferior de 4.5 cm tomándola desde la línea de ventaja de costura inferior hacia arriba. 
          ...
          .row.justify-content-center.mb-0(data-aos="zoom-in-left")
            .col-lg-11.col-sm-12
              ...
              .row.align-items-center.justify-content-center.mb-0(data-aos="flip-up")
                .col-lg-8
                  p Luego sobre el primer punto marcado, se debe trazar a un intervalo de 1.2 cm hacia arriba 2 puntos más y a escuadra, trazar una línea de 9 cm hacia la margen izquierda y repítala. 
          ...
          .row.justify-content-center.mb-0(data-aos="flip-up")
            .col-lg-11.col-sm-12
              ...
              .row.align-items-center.justify-content-center.mb-0
                .col-lg-8
                  p Posteriormente a escuadra trazar una línea a 1.5 cm desde el primer punto final del lado izquierdo del molde que mida 6.5 cm y debajo de ésta, trazar un rectángulo de 6.5 cm x 4.5 cm.
          ...
          .row.justify-content-center.align-items-center.py-4
            ...
            .col-lg-10.py-4
              ...
              .row.justify-content-around.align-items-center.mb-2
                .col.mb-3.mb-sm-0
                  h5.mb-2.cafe Cartilla Técnico - Pedagógica corporación de desarrollo productivo del cuero, calzado y marroquinería. 
                .col-sm-auto.col-lg-3
