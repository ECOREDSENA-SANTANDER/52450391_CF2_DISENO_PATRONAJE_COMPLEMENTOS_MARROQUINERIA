...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.my-5
      .col-lg-12
        .row.justify-content-center.align-items-center.fondocortot3
          .col-lg-12
    ...
    .row.justify-content-center.align-items-center
      .col-lg-12
        .row.justify-content-center.align-items-center.fondolargot3.mb-5
          .col-lg-12
            .row.justify-content-center.mb-4(data-aos="zoom-in-left")
              .col-lg-8.col-11
                .row.justify-content-start.mb-0(data-aos="zoom-in-left")
                  .col-sm-12.col-lg-7.col-12.py-4
                    br
                    h3.bg5.py-2.w-card-text2 Molde
          ...
          .col-lg-8.col-11
            .row.align-items-center.justify-content-center.mb-4(data-aos="flip-up")
              .col-lg-12.col-sm-12
                .titulo-sexto.color-acento-contenido.text-negro
    ...
    .row.justify-content-center.align-items-center.fondolargot3.mb-4
      .col-lg-12.col-11
